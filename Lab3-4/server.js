...
// Middleware логування (повинен бути ДО маршрутів)
...
// (Опційно, але корисно) Отримання однієї замітки за id
...
// Оновлення замітки за ідентифікатором (PUT – повне оновлення)
